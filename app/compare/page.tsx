...
export default function ComparePage() {
  ...
  // Fetch available funds for selection
  const { funds: availableFunds, loading: fundsLoading } = useFunds({
    query: searchQuery,
    limit: 100, // Increased to load more funds for better filtering
  });
  ...
  // Filter available funds to exclude already selected ones and apply category filter
