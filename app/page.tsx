        ...
        <div className="mx-auto max-w-7xl relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-md rounded-full mb-8 border border-white/30">
              ...
              <span className="text-sm font-semibold text-white">Trusted by 10,000+ Investors</span>
            </div>
            ...
            <p className="text-xl sm:text-2xl text-white/90 max-w-3xl mx-auto mb-12 font-light">
              Track 5000+ funds • Calculate returns • Compare intelligently • Invest confidently
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {[
                { icon: Calculator, label: "Smart Calculators", value: "5+", gradient: "from-blue-400 to-blue-600" },
                { icon: BarChart3, label: "Mutual Funds", value: "5000+", gradient: "from-purple-400 to-purple-600" },
                { icon: Target, label: "Fund Analysis", value: "Real-time", gradient: "from-pink-400 to-pink-600" },
                { icon: Shield, label: "Secure & Trusted", value: "100%", gradient: "from-orange-400 to-orange-600" },
              ].map((feature, idx) => (
                <motion.div
                  key={idx}
                ...
                >
                  ...
                  <p className="text-3xl font-bold text-white mb-1">{feature.value}</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex gap-2 overflow-x-auto py-4 scrollbar-hide">
            {[
              ...
              { id: "commodity" as const, label: "Commodity Funds", icon: Building2 },
          ...
          >
            {activeTab === "equity" && (
              <div className="space-y-6">
                ...
                <FundList funds={equityFunds.slice(0, 12)} language={language} />
              </div>
            )}
            ...
            {activeTab === "commodity" && (
              <div className="space-y-6">
                ...
                {commodityFunds.length > 0 ? (
                  <FundList funds={commodityFunds.slice(0, 12)} language={language} />
                ) : (
                  <Card className="bg-white/60 backdrop-blur-xl shadow-xl">
                    <CardContent className="pt-12 pb-12 text-center">
                      <Building2 className="w-16 h-16 mx-auto mb-4 text-gray-400" />
                      <p className="text-lg text-gray-600">No commodity funds available</p>
                    </CardContent>
                  </Card>
                )}
              </div>
            ...
            {activeTab === "news" && (
              <div className="space-y-6">
                ...
                {newsLoading ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {news.map((article) => (
                      <Card key={article.id} className="backdrop-blur-xl shadow-xl hover:shadow-2xl transition-all">
                ...
                {watchlistFunds.length > 0 ? (
                  ...
                  <Card className="backdrop-blur-xl shadow-xl">
                    <CardContent className="pt-16 pb-16 text-center">
                      ...
                      <p className="text-gray-600 mb-8">Start adding funds to track them</p>
                      <Link href="/search">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 sm:grid-cols-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">India's premier mutual funds platform</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><Link href="/alerts" className="hover:text-primary">Alerts</Link></li>
              </ul>
            </div>
            <div>
