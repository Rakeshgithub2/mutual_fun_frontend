...
export function Header() {
  ...
  // Check authentication status immediately and on changes
  useEffect(() => {
    const checkAuth = () => {
            ...
            {!isSignedIn ? (
              ...
              <div className="relative hidden lg:block">
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg hover:bg-card px-2 py-2 transition-colors"
                  title={`Signed in as ${
                    userData?.name || userData?.email || "User"
                  }`}
                >
                  <div className="relative w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-semibold text-lg shadow-md">
